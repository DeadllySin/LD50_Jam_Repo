...
{
    const string privateCode = "bUveRZ4xP06xr3g_P46-VwhUtpT7-oq06tFOPmbt350w";  //Key to Upload New Info
    const string publicCode = "627fd1148f40bb11c049724a";   //Key to download
